...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['tran_id'] = "eJzTd9cP8TD2DDcGAAsZAkg%3D"; // tran_id must be unique
        ...
        // $post_data['product_profile'] = "airline-tickets";
    ...
    public function success(Request $request)
    {
        ...
        $order_details = DB::table('flight_bookings')
            ->where('booking_id', $tran_id)
            ->select('booking_id', 'payment_status', 'billing_currency', 'grand_total_price')->first();
